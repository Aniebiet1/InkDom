          ...
          <div className="w-full max-w-md mx-auto">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="mt-8 space-y-5">
              <Field label="Full name" icon={<User className="h-4 w-4" />}>
                <input type="text" placeholder="Adaeze Nwosu" className="w-full bg-transparent outline-none text-sm placeholder:text-foreground/40" />
              </Field>
              <Field label="Email address" icon={<Mail className="h-4 w-4" />}>
                <input type="email" placeholder="you@example.com" className="w-full bg-transparent outline-none text-sm placeholder:text-foreground/40" />
              </Field>
              ...
              >
                <input type={show ? "text" : "password"} placeholder="At least 8 characters" className="w-full bg-transparent outline-none text-sm placeholder:text-foreground/40" />
              </Field>
              ...
              <button type="button" className="w-full inline-flex items-center justify-center gap-2 rounded-full border border-emerald-line/50 py-3 text-sm hover:bg-emerald-soft/30 transition">
                <GoogleIcon /> Sign up with Google
              </button>

              <p className="text-center text-xs text-foreground/60 pt-2">
                Already have an account?{" "}
                <Link to="/login" className="text-gold font-medium hover:underline">Log in</Link>
              </p>
            </form>
          </div>
        </motion.div>
